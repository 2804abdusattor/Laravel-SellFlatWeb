...
<h3 class="jumbotron"><i class="glyphicon glyphicon-upload"></i> Добавление изображения</h3>
<form method="post" action="{{url('upload_data')}}" enctype="multipart/form-data">
  {{csrf_field()}}
        ...
        <button type="submit" class="btn btn-info" style="margin-top:12px"><i class="glyphicon glyphicon-check"></i>Разместить</button>
  </form>
   <br><hr>

   <h4><i class="glyphicon glyphicon-picture"></i> Отображение изображения    </h4>
